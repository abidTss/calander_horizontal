...
public class MonthFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dateHeaderTitle =   rootView.findViewById(R.id.date_title);
        previousHeaderImage =  rootView.findViewById(R.id.left_header_img);
        forwardHeaderImage = rootView.findViewById(R.id.right_header_img);
        init();
        return rootView;
    }
